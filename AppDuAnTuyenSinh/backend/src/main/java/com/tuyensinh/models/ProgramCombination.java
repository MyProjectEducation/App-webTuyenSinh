...
public class ProgramCombination {
    ...
    @Column(name = "N1") private int n1;
    @Column(name = "TO") private int to;
    @Column(name = "LI") private int li;
    @Column(name = "HO") private int ho;
    @Column(name = "SI") private int si;
    @Column(name = "VA") private int va;
    @Column(name = "SU") private int su;
    @Column(name = "DI") private int di;
    @Column(name = "TI") private int ti;
    @Column(name = "KHAC") private int khac;
    @Column(name = "KTPL") private int ktpl;
    ...
    public ProgramCombination(int id, String manganh, String matohop, String th_mon1, int hsmon1, 
        ...
        this.id = id; this.manganh = manganh; this.matohop = matohop;
        this.th_mon1 = th_mon1; this.hsmon1 = hsmon1;
        this.th_mon2 = th_mon2; this.hsmon2 = hsmon2;
        this.th_mon3 = th_mon3; this.hsmon3 = hsmon3;
        this.tb_keys = tb_keys;
        this.n1 = n1; this.to = to; this.li = li; this.ho = ho; this.si = si;
        this.va = va; this.su = su; this.di = di; this.ti = ti; this.khac = khac; this.ktpl = ktpl;
        this.dolech = dolech;
    }
    ...
    public int getLi() { return li; }
    public void setLi(int li) { this.li = li; }
    ...
    public int getKhac() { return khac; }
    public void setKhac(int khac) { this.khac = khac; }
    public int getKtpl() { return ktpl; }
    public void setKtpl(int ktpl) { this.ktpl = ktpl; }
